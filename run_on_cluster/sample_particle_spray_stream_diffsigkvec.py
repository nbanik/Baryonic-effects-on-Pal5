...
def get_options():
    ...
    parser.add_option("--ftrail",dest='ftrail',default=None,
                      help="output file name")
                      
    parser.add_option("--t_on",dest='t_on',default=-2.,
                      type='float',
...
barpot,nobarpot=SCFbar_util.Particle_Spray_MWPotentialSCFbar(mbar=Mbar,Acos=Ac,Asin=As,t_on=-5.,pat_speed=pat_speed,tstream=td)
...
spdf= streamspraydf.streamspraydf(50000.*units.Msun,progenitor=pal5,pot=barpot,tdisrupt=td*units.Gyr,sigkvec=[0.2,0.,0.2,0.5,0.5,0.])
spdft= streamspraydf.streamspraydf(50000.*units.Msun,progenitor=pal5,pot=barpot,leading=False,tdisrupt=td*units.Gyr,sigkvec=[0.2,0.,0.2,0.5,0.5,0.])
