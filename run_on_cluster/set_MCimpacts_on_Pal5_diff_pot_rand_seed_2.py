...
def get_options():
    ...
    parser.add_option("--rand_seed_ind",dest='rand_seed_ind',default=None,
                      type='int',
                      help="random seed index")
...
rand_int=[76450, 25675, 9346, 28965, 2622, 71267, 20803, 42677, 46559, 37424, 41954, 3185, 67692, 71604, 36867, 12540, 91250, 25883, 50408, 17324]
...
np.random.seed(rand_int[options.rand_seed_ind])
...
pepperfilename='Pal5_{}_on_128impact_Plummer_td{}_Mmin105_chainind_{}_seedind_second.pkl'.format(options.nsam,options.td,options.ind,options.rand_seed_ind)
