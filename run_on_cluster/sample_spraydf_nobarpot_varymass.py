...
for ii in range(len(Mbar)):
    ...
    folder='/ufrc/tan/nilanjan1/galpy/sampled_SCFbar/' + Mbar_str[ii] + 'Msun_{}_nobarpot_spraydf/trailing/'.format(int(pat_speed))
    ...
    SCFbar_util.sample_spraydf_pal5_noprog(N,nobarpot,nobarpot,fo=fpath)
    SCFbar_util.sample_spraydf_pal5_noprog(N,nobarpot,nobarpot,trailing=False,fo=fpath)
