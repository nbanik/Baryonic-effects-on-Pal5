    ...
    for fr in FR_frac :
        ...
        for n in N :
            ...
            for p in pat_speed :
                    ...
                    folder='/ufrc/tan/nilanjan1/galpy/sampled_spiral/spiralN{}_{}patspeed_FR{}_{}Gyr_streamdf/trailing/'.format(n,p,fr,int(np.abs(t)))
                    folder_lead=folder.replace('trailing','leading')
                    
                    fot='sample500_spiral_streamdf_trailing_N{}_{}patspeed_{}Gyr_{}FR_streamdf_{}.dat'.format(n,p,int(np.abs(t)),fr,ind)
                    ...
                    spiralarms_util.sample_streamdf_pal5_noprog_spiral(Nsamples,spiralpot,fo=fpath)
                    spiralarms_util.sample_streamdf_pal5_noprog_spiral(Nsamples,spiralpot,trailing=False,fo=fpath)
