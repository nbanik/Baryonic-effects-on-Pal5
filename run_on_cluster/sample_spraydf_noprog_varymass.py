...
def get_options():
    ...
    parser.add_option("--ft",dest='ft',default=None,
...
for ii in range(len(Mbar)):
    ...
    folder='/ufrc/tan/nilanjan1/galpy/sampled_SCFbar/' + Mbar_str[ii] + 'Msun_{}patspeed_spraydf_noprog/trailing/'.format(int(pat_speed))
    ...
    SCFbar_util.sample_spraydf_pal5_noprog(N,barpot,nobarpot,fo=fpath)
    SCFbar_util.sample_spraydf_pal5_noprog(N,barpot,nobarpot,trailing=False,fo=fpath)
